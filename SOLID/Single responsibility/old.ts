...
const _musicToggleElement = <HTMLElement>document.querySelector('#music-toggle');
const _musicSliderElement = <HTMLInputElement>document.querySelector('#music-slider');
const _engineToggleElement = <HTMLInputElement>document.querySelector('#engine-toggle');
const _addFuelForm = document.querySelector('#add-fuel-form');
...
_musicToggleElement.addEventListener('click', () => {
    if(car.musicLevel === 0) {
        car.turnMusicOn();
...
_musicSliderElement.addEventListener('input', (event) => {
...
_engineToggleElement.addEventListener('click', () => {
    if(car.engineStatus) {
        car.turnEngineOff();
...
_addFuelForm.addEventListener('submit', (event) => {
...
setInterval(() => {
    ...
    _milesElement.innerText = <string><unknown>(car.miles);
